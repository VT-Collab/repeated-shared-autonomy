...
import os
import copy
from record_demos import S_FACTOR, GOAL_EE
...
def main():
    ...
    savename = 'data/' + 'class_' + str(S_FACTOR) + '.pkl'
            ...
            for snip in snippets:
                ...
                for i in range(deformed_samples):
                    ...
                    for idx in range(start, deform_len):
                        ...
                        false_cnt += 1
    data = {}
    data['deform_samples'] = deformed_samples
    ...
    model = Net().to(device)
    dataname = 'data/' + 'class_' + str(S_FACTOR) + '.pkl'
    savename = 'models/' + 'class_' + str(S_FACTOR)
