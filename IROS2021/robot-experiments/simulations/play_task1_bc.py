        ...
        while dist > 0.02 and elapsed_time < total_time:
            ...
            if action_interval > 0.005:
                ...
                if elapsed_time < .5:
                    ...
                    confidence = 1.0
                    qdot_h = np.clip(qdot_h, -0.1, 0.1) + np.clip(noise, -0.075, 0.075)
                    qdot = confidence * 4. * np.asarray(qdot_r)# + (1 - confidence) * qdot_h
                    if print_flag:
...
def main():
    ...
    class_model = "models/task_1_class_" + str(5)
        ...
        if start:
            ...
            while current_run < total_run:
                ...
                if choice == 0:
                    ...
                    filename = save_loc + "n_bclo_" + str(demos_num) + "_" + str(notepad_count) + ".pkl"
                    notepad_count += 1
                elif choice == 1:
                    print('[*] My goal is soupcan')
                    dataset = go2goal(conn, SOUPCAN, model)
                    filename = save_loc + "c_bclo_" + str(demos_num) + "_" + str(soupcan_count) + ".pkl"
                    soupcan_count += 1
                # elif choice == 2:
                ...
                #     cup_count += 1
                    ...
                    filename = save_loc + "t_bclo_" + str(demos_num) + "_" + str(tape_count) + ".pkl"
                    tape_count += 1
