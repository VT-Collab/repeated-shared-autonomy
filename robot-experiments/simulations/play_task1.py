        ...
        if start:
            ...
            while current_run < total_run:
                ...
                if choice == 0:
                    ...
                    filename = save_loc + "n_ours_" + str(demos_num) + "_" + str(notepad_count) + ".pkl"
                    notepad_count += 1
                elif choice == 1:
                    print('[*] My goal is soupcan')
                    dataset = go2goal(conn, SOUPCAN, model)
                    filename = save_loc + "c_ours_" + str(demos_num) + "_" + str(soupcan_count) + ".pkl"
                    soupcan_count += 1
                # elif choice == 2:
                # ours_" + str(demos_num) + "_" 
                ...
                #     cup_count += 1
                    ...
                    filename = save_loc + "t_ours_" + str(demos_num) + "_" + str(tape_count) + ".pkl"
                    tape_count += 1
                pickle.dump(dataset, open(filename, "wb"))
                print('[*] This is an element in my dataset: ', dataset[0])
